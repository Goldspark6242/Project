        ...
        <table class="table align-middle mb-0 bg-white table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr id="a<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="aadhar"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                <!-- ==================== 100_Days job card ================  -->
                <tr id="j<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="hundred_days"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                ...
                <tr id="pip<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="pip_num_or_bpl_card"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                ...
                <tr id="c<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="community"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                ...
                <tr id="c<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="smartcard"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                ...
                <tr id="tc<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="marksheet"
                                class="btn fw-bold btn2 btn-sm ">View</button>
                        </div>
                    </td>
                </tr>
                ...
                <tr id="pass<?php echo $id;?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button type="button" data-id="<?php echo $id;?>" data-type="passbook"
                                class="btn btn-sm fw-bold btn2">View</button>
                        </div>
                    </td>
                </tr>
                <!-- ==================== end of PassBook ================  -->
